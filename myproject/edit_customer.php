...
<ul> 
         ...
         <li><strong> Edit Customer</strong></li>
...
?>
<p>
<form name="frm_edit" method="POST" action="classes/controller/edit_controller.php">
<?php
	/*$msg=" ";
...
<tr> 
    <td width="50"><label for="first_name">First Name</label></td>
    <td width="50"><input type="text" name="first_name" value="<?php echo $rs_array[0][0]?>"></td> 
</tr>
<tr>
    <td width="50"><label for="last_name">Last Name</label></td>
    <td width="50"> <input type="text" name="last_name" value="<?php echo $rs_array[0][1]?>"></td>
</tr>
<tr> 
    <td width="50"><label for="email_id">Email</label></td>
    <td width="50"><input type="text" name="email_id" placeholder="abc@gmail.com" value="<?php echo $rs_array[0][2]?>" readonly></td> 
</tr> 
<tr>
    <td width="50"><label for="address">Address</label></td>
    <td width="50"><input type="textarea" name="address" id="address" value="<?php echo $rs_array[0][3]?>"></td>
</tr>
<tr>
    <td width="50"><label for="phone_no">Phone No.</label></td>
    <td width="50"><input type="text" name="phone_no" id="phone_no" value="<?php echo $rs_array[0][4]?>"></td>
</tr> 
<tr>
