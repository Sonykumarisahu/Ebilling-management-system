...
<ul>
        ...
        <li><a href="viewcustomeradmin_form.php">View Customer</a></li>
...
?>
<p>
<form name="frm_edit" method="POST" action="classes/controller/editproduct_controller.php">
...
<tr> 
    ...
    <td width="50"><input type="text" name="product_name" value="<?php echo $rs_array[0][1]?>"></td> 
</tr>
<tr>
    <td width="50">Duration</td>
    <td width="50"><input type="text" name="duration" value="<?php echo $rs_array[0][2]?>"></td>
</tr>
<tr> 
    <td width="50">Price</td>
    <td width="50"><input type="text" name="price" value="<?php echo $rs_array[0][3]?>"></td> 
</tr>  
<tr>
