...
<?php
   ...
   $rs_array = $obj->getAllUserDetails();
   //$rs_array = $obj->get_result_array($query);
	if(empty($rs_array))
	{
...
foreach($rs_array as $rs) 
{
  ...
  ?>
   <tr> 
      <td width="50"><?php echo $rs[0]?></td>
	  <td width="50"><?php echo $rs[1]?></td>
      <td width="50"><?php echo $rs[2]?></td>
      <td width="50"><?php echo $rs[3]?></td>
      <td width="50"><?php echo $rs[4]?></td>
      <td width="50"><?php echo $rs[5]?></td>     
    </tr>
   <?php
   }
  }
